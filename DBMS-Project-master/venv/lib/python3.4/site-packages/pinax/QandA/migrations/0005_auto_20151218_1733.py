...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='image',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='QandA.Post', verbose_name='Post'),
        ),
        migrations.AlterField(
            model_name='image',
            name='timestamp',
        ...
        migrations.AlterField(
            model_name='post',
            name='primary_image',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='QandA.Image', verbose_name='Primary Image'),
        ),
        migrations.AlterField(
            model_name='post',
            name='published',
        ...
        migrations.AlterField(
            model_name='reviewcomment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review_comments', to='QandA.Post', verbose_name='Post'),
        ),
        migrations.AlterField(
            model_name='reviewcomment',
            name='review_text',
        ...
        migrations.AlterField(
            model_name='revision',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='revisions', to='QandA.Post', verbose_name='Post'),
        ),
        migrations.AlterField(
            model_name='revision',
            name='published',
