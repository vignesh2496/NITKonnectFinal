    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_image', models.ForeignKey(related_name='+', blank=True, to='QandA.Image', null=True)),
            ],
            options={
                'ordering': ('-published',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(related_name='review_comments', to='QandA.Post')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(related_name='revisions', to='QandA.Post')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='image',
            name='post',
            field=models.ForeignKey(related_name='images', to='QandA.Post'),
